...
1. **LlamaIndex** (`llm/llama_index.py`):
   ...
   - See the upstream [LightRAG core programming guide](https://github.com/HKUDS/LightRAG/blob/main/docs/ProgramingWithCore.md) for maintained provider examples.
